...
RUN DEBIAN_FRONTEND=noninteractive \
    ...
    apt-get update && \
    apt-get install -qyy mxe-x86-64-w64-mingw32.static-qt5 mxe-x86-64-w64-mingw32.static-x265 yasm && \
    apt-get clean
...
COPY ./build-ffmpeg-mingw /build-ffmpeg-mingw
RUN /build-ffmpeg-mingw
